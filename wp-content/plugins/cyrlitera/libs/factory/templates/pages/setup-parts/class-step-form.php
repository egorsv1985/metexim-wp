...
class Step_Form extends Step {
	...
	public function __construct(\WBCR\Factory_Templates_114\Pages\Setup $page)
	{
	...
	protected function render_form(\Wbcr_FactoryForms461_Form $form)
	{
		?>
		<form method="post" id="w-factory-templates-114__setup-form-<?php echo $this->get_id() ?>" class="w-factory-templates-114__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-templates-114__form-buttons">
				<!--<input type="submit" name="skip_button_<?php /*echo $this->get_id() */ ?>" class="button-primary button button-large w-factory-templates-114__skip-button" value="<?php /*_e('Skip', 'wbcr_factory_templates_114') */ ?>">-->
				<input type="submit" name="continue_button_<?php echo $this->get_id() ?>" class="button-primary button button-large w-factory-templates-114__continue-button" value="<?php _e('Continue', 'wbcr_factory_templates_114') ?>">
			</div>
		</form>
		<?php
	}

	protected function set_form_handler(\Wbcr_FactoryForms461_Form $form)
	{
	...
	public function html()
	{
		...
		<div id="WBCR" class="wrap">
			<div class="wbcr-factory-templates-114-impressive-page-template factory-bootstrap-465 factory-fontawesome-000">
				<div class="w-factory-templates-114-setup__inner-wrap">
