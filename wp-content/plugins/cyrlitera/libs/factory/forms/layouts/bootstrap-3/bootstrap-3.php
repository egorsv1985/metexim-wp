<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms461_Bootstrap3FormLayout extends Wbcr_FactoryForms461_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms461_Control $control
			 */
