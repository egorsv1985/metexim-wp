<?php
	...
	add_action('wbcr_factory_forms_461_plugin_created', 'wbcr_factory_forms_461_plugin_created');

	function wbcr_factory_forms_461_plugin_created($plugin)
	{
		$plugin->forms = new Wbcr_FactoryForms461_Manager($plugin);
	}

	if( !class_exists('Wbcr_FactoryForms461_Manager') ) {

		class Wbcr_FactoryForms461_Manager {
			 ...
			 *
			 * @see FactoryForms461_Form::registerControl()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms461_Form::registerHolder()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms461_Form::registerCustomElement()
			 *
			 * @since 1.0.0
			 * @return void
			 */
	...
	if( !class_exists('Wbcr_FactoryForms461_Form') ) {
		/**
		 * An abstraction for forms.
		 */
		class Wbcr_FactoryForms461_Form {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_IFactoryForms461_ValueProvider
			 */
			private $provider;
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms461_FormLayout
			 */
			public $layout;
			 ...
			 */
			public function __construct(array $options, Wbcr_Factory464_Plugin $plugin)
			{
				// register controls once, when the first form is created
				if( !Wbcr_FactoryForms461_Manager::$controls_registered ) {

					do_action('wbcr_factory_forms_461_register_controls', $plugin);

					//if( !empty($plugin) ) {
					do_action('wbcr_factory_forms_461_register_controls_' . $plugin->getPluginName(), $plugin);
					//}

					Wbcr_FactoryForms461_Manager::$controls_registered = true;
				}
				...
				Wbcr_FactoryForms461_Manager::$temper = 'flat';
			}
			 ...
			 *
			 * @since 1.0.0
			 * @param Wbcr_IFactoryForms461_ValueProvider $provider
			 * @return void
			 */
			...
			{
				return apply_filters('wbcr_factory_464_form_items', $this->items, $this->name);
			}
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms461_Control[]
			 */
			 ...
			 * @return Wbcr_FactoryForms461_FormElement|null A form element.
			 */
			 ...
			 * @return Wbcr_FactoryForms461_FormElement[] Created elements.
			 */
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms461_Control A control object.
			 */
			public function createControl($item)
			{
				...
				if( is_array($item) ) {
					...
					$control_data = Wbcr_FactoryForms461_Manager::$registered_controls[$item['type']];
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms461_Holder A control holder object.
			 */
			public function createHolder($item)
			{
				...
				if( is_array($item) ) {
					...
					$holderData = Wbcr_FactoryForms461_Manager::$registered_holders[$item['type']];
			 ...
			 * @return Wbcr_FactoryForms461_FormElement A custom form element object.
			 */
			public function createCustomElement($item)
			{
				...
				if( is_array($item) ) {
					...
					$data = Wbcr_FactoryForms461_Manager::$registered_custom_elements[$item['type']];
			...
			public function html($options = array())
			{
				...
				if( !isset(Wbcr_FactoryForms461_Manager::$form_layouts[$this->form_layout]) ) {
					die(sprintf('[ERROR] The form layout %s was not found.', $this->form_layout));
				}

				// include a render code
				$layout_data = Wbcr_FactoryForms461_Manager::$form_layouts[$this->form_layout];
			...
			public static function connectAssetsForItem($item)
			{
				...
				if( self::isControl($type) ) {
					$haystack = Wbcr_FactoryForms461_Manager::$registered_controls;
				} elseif( self::isControlHolder($type) ) {
					$haystack = Wbcr_FactoryForms461_Manager::$registered_holders;
				}
			...
			{
				return isset(Wbcr_FactoryForms461_Manager::$registered_controls[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms461_Manager::$registered_holders[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms461_Manager::$registered_custom_elements[$item['type']]);
			}
		}
	}