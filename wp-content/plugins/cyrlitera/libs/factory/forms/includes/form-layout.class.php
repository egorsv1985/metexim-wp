<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms461_FormLayout extends Wbcr_FactoryForms461_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-461-' . $this->type);
				$this->addCssClass('factory-forms-461-' . $this->name);
			}
