<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms461_OptionsValueProvider implements Wbcr_IFactoryForms461_ValueProvider {
