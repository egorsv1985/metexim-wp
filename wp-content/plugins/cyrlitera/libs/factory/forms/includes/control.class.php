<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms461_Control extends Wbcr_FactoryForms461_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms461_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms461_ValueProvider $provider
			 * @return void
			 */
