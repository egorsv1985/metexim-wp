<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_ControlHolder') ) {
		/**
		 * The base class for control holders.
		 *
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms461_ControlHolder extends Wbcr_FactoryForms461_Control {
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms461_FormElement[].
			 */
