<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_WpEditorControl') ) {

		class Wbcr_FactoryForms461_WpEditorControl extends Wbcr_FactoryForms461_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_461_URL . '/assets/css/editor.css';
				}
			}
