<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms461_ColorAndOpacityControl extends Wbcr_FactoryForms461_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms461_IntegerControl($options['opacity'], $form, $provider);
