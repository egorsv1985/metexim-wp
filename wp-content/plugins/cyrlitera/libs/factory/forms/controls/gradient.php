<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_GradientControl') ) {
		class Wbcr_FactoryForms461_GradientControl extends Wbcr_FactoryForms461_Control {
			...
			public function html()
			{
				...
				<script>
					...
					factory.res.resVertical = '<?php _e( 'vertical', 'wbcr_factory_forms_461' ) ?>';
					factory.res.resHorizontal = '<?php _e( 'horizontal', 'wbcr_factory_forms_461' ) ?>';
				</script>
				<div <?php $this->attrs() ?>>
