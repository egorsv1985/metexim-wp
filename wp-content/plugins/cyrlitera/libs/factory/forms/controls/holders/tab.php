<?php
	...
	if( !class_exists('Wbcr_FactoryForms461_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms461_TabHolder extends Wbcr_FactoryForms461_Holder {
			 ...
			 * @param FactoryForms461_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms461_HtmlAttributeBuilder();
