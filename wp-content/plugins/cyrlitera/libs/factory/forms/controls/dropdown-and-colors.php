<?php
	 ...
	 *  // see FactoryForms461_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms461_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms461_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms461_DropdownAndColorsControl extends Wbcr_FactoryForms461_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms461_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms461_RadioColorsControl($options['colors'], $form, $provider);
