...
(function($) {
	...
	$.wfactory_464.filters = $.wfactory_464.filters || {
	...
	$.wfactory_464.hooks = $.wfactory_464.hooks || {

		/**
		 * Applies filters to a given input value.
		 */
		run: function(filterName, args) {
			$.wfactory_464.filters.run(filterName, args);
		},
		 ...
		 */
		add: function(filterName, callback, priority) {
			$.wfactory_464.filters.add(filterName, callback, priority);
		}
	};
