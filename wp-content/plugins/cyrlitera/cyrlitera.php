 ...
 * Framework Version: FACTORY_464_VERSION
 */
...
$wctr_plugin_info = array(
	...
	'load_factory_modules' => array(
		array('libs/factory/bootstrap', 'factory_bootstrap_465', 'admin'),
		array('libs/factory/forms', 'factory_forms_461', 'admin'),
		array('libs/factory/pages', 'factory_pages_464', 'admin'),
		array('libs/factory/templates', 'factory_templates_114', 'all'),
		array('libs/factory/adverts', 'factory_adverts_141', 'admin')
	)
);

$wctr_compatibility = new Wbcr_Factory464_Requirements(__FILE__, array_merge($wctr_plugin_info, array(
