...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (t = document.querySelector(".burger")) &&
    t.addEventListener("click", function (e) {
      if (s) {
        ...
        if (s) {
          var n = document.querySelectorAll("[data-lp]");
          for (let e = 0; e < n.length; e++) n[e].style.paddingRight = "0px";
          (o.style.paddingRight = "0px"),
            document.documentElement.classList.remove("lock"),
            (s = !1),
            setTimeout(function () {
              (s = !0), console.log("Скролл разблокирован");
            }, t);
        }
        ...
        if (!s) {
          var l = document.querySelectorAll("[data-lp]");
          ...
          (t.style.paddingRight =
            ...
            (s = !0),
            setTimeout(function () {
              (s = !1), console.log("Скролл заблокирован");
            }, o);
        }
  ...
  function e() {
    ...
    e.forEach((e) => {
      const n = parseInt(e.dataset.stickyTop) || 0,
        l = parseInt(e.dataset.stickyBottom) || 0;
      const s = e.hasAttribute("data-sticky-header")
            ...
            ? ((o = o.top + t - (s + n)),
              ...
              o <= t && t <= e
                ...
                ? ((i.style.position = "relative"),
                  ...
                  (i.style.right = "auto"),
                  (i.style.width = "auto"),
                  (o = c.offsetLeft + c.offsetWidth) <=
                    i.offsetLeft + i.offsetWidth &&
                    (i.style.width = o - i.offsetLeft + "px"))
                : ((i.style.position = "relative"),
                  (i.style.bottom = "auto"),
                  (i.style.top = n + "px"),
                  (i.style.right = "auto"),
  ...
  "scroll" in window && e();
  var t = document.querySelectorAll("[data-popup]"),
    o = document.querySelectorAll("[data-close]");
  function n(e) {
    e.preventDefault();
    (e = this.getAttribute("data-popup")), (e = document.querySelector(e));
    document.body.classList.toggle("popup-show"),
      e.classList.toggle("popup_show");
  }
  function l() {
    var e = document.querySelector(".popup_show");
  ...
  t.forEach(function (e) {
    ...
    t && t.includes("viber://") && e.setAttribute("data-href", t);
  }),
    t.forEach(function (o) {
      o.addEventListener("click", function (e) {
        var t = o.getAttribute("data-href");
        console.log("href:", href),
          console.log("data-href:", t),
          t && "" !== t.trim() && (o.href = t);
      });
    });
}),
